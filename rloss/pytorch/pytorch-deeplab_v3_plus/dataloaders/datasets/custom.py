...
class VOCSegmentation(Dataset):
    ...
    def __init__(self,
        ...
        """
        :param base_dir: path to custom dataset directory
        ...
        #BSH Added
        with open(os.path.join(self._base_dir, 'classes.txt'),'r') as f:
        ...
        if split == 'train':
            ...
            self._cat_dir = os.path.join(self._base_dir, 'PNGScribble')
        elif split == 'val':
            self._cat_dir = os.path.join(self._base_dir, 'PNGScribble') 
        ...
        for splt in self.split:
            ...
            for ii, line in enumerate(lines) :
                _image = os.path.join(self._image_dir, line + ".png") #jpg -> png 
